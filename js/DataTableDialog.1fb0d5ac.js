import{_ as D,R as B}from"./index.a81367a4.js";import{o as m,c as p,R as U,$ as h,ai as o,a0 as l,W as i,Z as n,a as y,_ as v,P as k,I as V,aj as A,X as $}from"./vendor-vue.d8369f41.js";const E={name:"ExpireDays",props:{value:{type:[Number,String],default:null}},components:{},data(){return{}},computed:{showValue(){return Number.isInteger(this.value)},className(){return this.showValue?this.value<7?["color--danger"]:this.value<30?["color--warning"]:["color--success"]:[]}},methods:{async getData(){}},created(){this.getData()}},T={class:"ExpireDays"},N={key:1};function z(s,t,e,g,d,a){return m(),p("div",T,[a.showValue?(m(),p("span",{key:0,class:U(a.className)},h(e.value),3)):(m(),p("span",N,"-"))])}const j=D(E,[["render",z]]),F={host:[{message:"\u4E3B\u673A\u5730\u5740\u4E0D\u80FD\u4E3A\u7A7A",required:!0,trigger:"blur"}],host_connect_status:[{message:"\u4E3B\u673A\u8FDE\u63A5\u72B6\u6001\u4E0D\u80FD\u4E3A\u7A7A",required:!0,trigger:"blur"}],host_check_time:[{message:"\u4E3B\u673A\u68C0\u67E5\u65F6\u95F4\u4E0D\u80FD\u4E3A\u7A7A",required:!0,trigger:"blur"}]},Y={name:"",props:{row:{type:Object,default:null},domainId:{type:Number,default:null}},components:{},data(){return{rules:F,is_auto_update:!0,form:{host:"",host_connect_status:"",host_check_time:"",ssl_start_time:"",ssl_expire_time:"",ssl_check_time:"",ssl_expire_days:"",ssl_expire_monitor:!0,ssl_auto_update:!0,comment:""}}},computed:{disabledTime(){return this.is_auto_update}},methods:{async getDomainById(){let s={domain_id:this.domainId};const t=await this.$http.getDomainById(s);t.ok&&(this.is_auto_update=t.data.auto_update)},async getData(){if(await this.getDomainById(),this.row){let s={address_id:this.row.id};const t=await this.$http.getAddressById(s);if(t.code!=0)return;let e=t.data;this.form.host=e.host,this.form.host_connect_status=e.host_connect_status,this.form.host_check_time=e.host_check_time,this.form.ssl_start_time=e.ssl_start_time,this.form.ssl_expire_time=e.ssl_expire_time,this.form.ssl_check_time=e.ssl_check_time,this.form.ssl_expire_days=e.ssl_expire_days,this.form.ssl_auto_update=e.ssl_auto_update,this.form.ssl_expire_monitor=e.ssl_expire_monitor,this.form.comment=e.comment}},handleCancel(){this.$emit("on-cancel")},handleSubmit(){this.$refs.form.validate(s=>{if(s)this.confirmSubmit();else return!1})},async confirmSubmit(){let s=this.$loading({fullscreen:!0}),t={domain_id:this.domainId,host:this.form.host.trim(),ssl_start_time:this.form.ssl_start_time,ssl_expire_time:this.form.ssl_expire_time,comment:this.form.comment},e=null;this.row?(t.address_id=this.row.id,e=await this.$http.updateAddressById(t)):e=await this.$http.addAddress(t),e.code==0?(this.$msg.success("\u64CD\u4F5C\u6210\u529F"),this.$emit("on-success")):this.$msg.error(e.msg),this.$nextTick(()=>{s.close()})}},created(){this.getData()}},P={class:"text-center mt-md"};function H(s,t,e,g,d,a){const c=o("el-input"),u=o("el-form-item"),f=o("el-form"),b=o("el-button");return m(),p("div",null,[l(f,{ref:"form",model:d.form,rules:d.rules,"label-width":"100px"},{default:i(()=>[n(" \u4E3B\u673A\u5730\u5740 "),l(u,{label:"\u4E3B\u673AIP\u5730\u5740",prop:"host"},{default:i(()=>[l(c,{type:"text",style:{width:"220px"},modelValue:d.form.host,"onUpdate:modelValue":t[0]||(t[0]=_=>d.form.host=_),placeholder:"\u8BF7\u8F93\u5165\u4E3B\u673A\u5730\u5740"},null,8,["modelValue"])]),_:1}),n(" \u4E3B\u673A\u8FDE\u63A5\u72B6\u6001 "),n(" \u8BC1\u4E66\u9881\u53D1\u65F6\u95F4 "),n(` <el-form-item
      ...
      </el-table-column> `),l(c,{label:"\u64CD\u4F5C",width:"90",align:"center",prop:"tag"},{default:i(r=>[l(_,{underline:!1,type:"primary",class:"mr-sm",disabled:e.disableUpdateButton,onClick:w=>a.handleUpdateRowDomainInfo(r.row)},{default:i(()=>[l(b,null,{default:i(()=>[l(f)]),_:1})]),_:1},8,["disabled","onClick"]),n(" \u7528\u6237\u53EF\u89C1 "),d.RoleEnum.User==e.role?(m(),p(V,{key:0},[l(_,{underline:!1,type:"primary",class:"mr-sm",onClick:w=>a.handleEditRow(r.row),disabled:!e.domainRow.has_edit_permission||r.row.source==0},{default:i(()=>[l(b,null,{default:i(()=>[l(C)]),_:1})]),_:1},8,["onClick","disabled"]),l(I,{title:`${s.$t("\u786E\u5B9A\u5220\u9664")}\uFF1F`,onConfirm:w=>a.handleDeleteClick(r.row),disabled:!e.domainRow.has_edit_permission},{reference:i(()=>[l(_,{underline:!1,type:"danger",disabled:!e.domainRow.has_edit_permission},{default:i(()=>[l(b,null,{default:i(()=>[l(x)]),_:1})]),_:1},8,["disabled"])]),_:1},8,["title","onConfirm","disabled"])],64)):n("v-if",!0)]),_:1})]),_:1},8,["data"]),n(" \u7F16\u8F91\u6846 "),l(S,{visible:d.dialogVisible,"onUpdate:visible":t[1]||(t[1]=r=>d.dialogVisible=r),row:d.currentRow,domainId:e.domainId,onOnSuccess:a.handleUpdateSuccess},null,8,["visible","row","domainId","onOnSuccess"])])}const Z=D(W,[["render",X]]),G={name:"address-list",props:{domainRow:{type:Object,default:null},domainId:{type:Number,default:null},role:{type:Number}},components:{DataFormDialog:O,DataTable:Z},data(){return{RoleEnum:B,list:[],total:0,page:1,size:10,keyword:"",selectedRows:[],loading:!0,dialogVisible:!1,is_auto_update:!0}},computed:{disableUpdateButton(){return!this.is_auto_update},showBatchDeleteButton(){return!!(this.selectedRows&&this.selectedRows.length>0)}},methods:{async resetData(){this.page=1,await this.getData()},async getDomainById(){let s={domain_id:this.domainId};const t=await this.$http.getDomainById(s);t.ok&&(this.is_auto_update=t.data.auto_update)},async getData(){this.loading=!0;let s={domain_id:this.domainId,page:this.page,size:this.size};try{const t=await this.$http.getAddressListByDomainId(s);t.code==0&&(this.list=t.data.list,this.total=t.data.total)}catch(t){console.log(t)}finally{this.loading=!1}},handleAddRow(){this.dialogVisible=!0},handleAddSuccess(){this.resetData()},handleSearch(){this.resetData()},async updateAllAddress(){let s=this.$loading({fullscreen:!0}),t={domain_id:this.domainId},e=await this.$http.updateAddressListInfoByDomainId(t);e.code==0?(this.$msg.success("\u64CD\u4F5C\u6210\u529F"),this.resetData()):this.$msg.error(e.msg),this.$nextTick(()=>{s.close()})},handleSizeChange(s){this.resetData()},handleSelectionChange(s){this.selectedRows=s},async handleBatchDeleteConfirm(){let s=this.$loading({fullscreen:!0}),t={address_ids:this.selectedRows.map(e=>e.id)};try{(await this.$http.deleteAddressByIds(t)).ok&&(this.$msg.success("\u64CD\u4F5C\u6210\u529F"),this.resetData())}catch(e){console.log(e)}finally{this.$nextTick(()=>{s.close()})}}},created(){this.resetData()}},J={class:""},K={class:"flex justify-between items-center"},Q={key:1};function ee(s,t,e,g,d,a){const c=o("Plus"),u=o("el-icon"),f=o("el-button"),b=o("Delete"),_=o("el-link"),C=o("el-popconfirm"),x=o("Refresh"),I=o("DataTable"),R=o("el-pagination"),S=o("DataFormDialog"),r=A("loading");return m(),p("div",J,[n(" \u64CD\u4F5C\u6309\u94AE "),y("div",K,[d.RoleEnum.User==e.role?(m(),k(f,{key:0,type:"primary",onClick:a.handleAddRow,disabled:!e.domainRow.has_edit_permission},{default:i(()=>[l(u,null,{default:i(()=>[l(c)]),_:1}),v(h(s.$t("\u6DFB\u52A0")),1)]),_:1},8,["onClick","disabled"])):(m(),p("span",Q)),y("div",null,[a.showBatchDeleteButton?(m(),k(C,{key:0,title:"\u786E\u5B9A\u5220\u9664\u9009\u4E2D\uFF1F",onConfirm:a.handleBatchDeleteConfirm},{reference:i(()=>[l(_,{underline:!1,type:"danger",class:"mr-sm"},{default:i(()=>[l(u,null,{default:i(()=>[l(b)]),_:1}),t[3]||(t[3]=v("\u6279\u91CF\u5220\u9664",-1))]),_:1})]),_:1},8,["onConfirm"])):n("v-if",!0),l(_,{underline:!1,type:"primary",disabled:a.disableUpdateButton,onClick:a.updateAllAddress},{default:i(()=>[l(u,null,{default:i(()=>[l(x)]),_:1}),v(h(s.$t("\u5168\u90E8\u66F4\u65B0")),1)]),_:1},8,["disabled","onClick"])]),n(` <el-input
        class="ml-sm"
        style="width: 260px"
        v-model="keyword"
        placeholder="\u8F93\u5165\u57DF\u540D"
      ...
      </el-input> `)]),n(" \u6570\u636E\u5217\u8868 "),$(l(I,{class:"mt-sm",list:d.list,role:e.role,domainId:e.domainId,domainRow:e.domainRow,disableUpdateButton:a.disableUpdateButton,onOnSuccess:a.resetData,onOnSelectionChange:a.handleSelectionChange},null,8,["list","role","domainId","domainRow","disableUpdateButton","onOnSuccess","onOnSelectionChange"]),[[r,d.loading]]),n(" \u7FFB\u9875 "),l(R,{class:"mt-md justify-center",background:"",layout:"total, sizes, prev, pager, next",total:d.total,"page-size":d.size,"onUpdate:pageSize":t[0]||(t[0]=w=>d.size=w),"current-page":d.page,"onUpdate:currentPage":t[1]||(t[1]=w=>d.page=w),onCurrentChange:a.getData,onSizeChange:a.handleSizeChange},null,8,["total","page-size","current-page","onCurrentChange","onSizeChange"]),n(" \u7F16\u8F91\u6846 "),l(S,{visible:d.dialogVisible,"onUpdate:visible":t[2]||(t[2]=w=>d.dialogVisible=w),domainId:e.domainId,onOnSuccess:a.handleAddSuccess},null,8,["visible","domainId","onOnSuccess"])])}const te=D(G,[["render",ee]]),se={name:"",props:{domainRow:{type:Object,default:null},row:{type:Object,default:null},visible:{type:Boolean,default:!1},domainId:{type:Number,default:null},role:{type:Number}},components:{DataTableIndex:te},data(){return{}},computed:{dialogTitle(){return this.row?"\u7F16\u8F91":"\u6DFB\u52A0"},dialogVisible:{get(){return this.visible},set(s){this.$emit("update:visible",s)}}},methods:{handleClose(){this.dialogVisible=!1},handleOpen(){this.dialogVisible=!0},handleSuccess(){this.handleClose(),this.$emit("on-success")},handleDialogClose(){this.$emit("on-close")}},created(){}};function le(s,t,e,g,d,a){const c=o("DataTableIndex"),u=o("el-dialog");return m(),p(V,null,[n(" \u7F16\u8F91\u6846 "),l(u,{title:"\u57DF\u540D\u4E3B\u673A\u5217\u8868",modelValue:a.dialogVisible,"onUpdate:modelValue":t[0]||(t[0]=f=>a.dialogVisible=f),width:"960px",center:"","append-to-body":"",onClose:a.handleDialogClose},{default:i(()=>[a.dialogVisible?(m(),k(c,{key:0,row:e.row,role:e.role,domainRow:e.domainRow,domainId:e.domainId,onOnCancel:a.handleClose,onOnSuccess:a.handleSuccess},null,8,["row","role","domainRow","domainId","onOnCancel","onOnSuccess"])):n("v-if",!0)]),_:1},8,["modelValue","onClose"])],2112)}const ie=D(se,[["render",le]]);export{te as A,j as E,ie as a};
