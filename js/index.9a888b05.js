import{C}from"./ConnectStatus.61524237.js";import{_ as f}from"./index.f78edc3a.js";import{ai as o,o as _,c as b,U as a,O as i,a as d,T as p,R as n,aq as k,P as $,S as v}from"./vendor-vue.279aabbf.js";import"./element-plus.2186919a.js";import"./element-icon.a3660786.js";import"./vendor-lib.c8503388.js";const z={name:"",components:{ConnectStatus:C},props:{list:{type:Array}},computed:{},data(){return{currentRow:null,dialogVisible:!1}},methods:{handleEditRow(e){this.currentRow=e,this.dialogVisible=!0},async handleDeleteClick(e){let t={id:e.id};const s=await this.$http.function(t);s.code==0?(this.$msg.success("\u64CD\u4F5C\u6210\u529F"),this.$emit("on-success")):this.$msg.error(s.msg)},async handleStatusChange(e){let t={id:e.id};const s=await this.$http.function(t);s.code==0?(this.$msg.success("\u64CD\u4F5C\u6210\u529F"),this.$emit("on-success")):this.$msg.error(s.msg)},handleUpdateSuccess(){this.$emit("on-success")}},created(){}};function V(e,t,s,w,r,u){const c=o("el-table-column"),m=o("ConnectStatus"),h=o("el-table");return _(),b("div",null,[a(h,{data:s.list,stripe:"",border:""},{default:i(()=>[a(c,{label:e.$t("\u5E8F\u53F7"),align:"center",prop:"id",width:"60"},{default:i(l=>[d("span",null,p(l.$index+1),1)]),_:1},8,["label"]),n(" \u72B6\u6001 "),n(" \u521B\u5EFA\u65F6\u95F4 "),a(c,{label:e.$t("\u5F00\u59CB\u65F6\u95F4"),"header-align":"center",align:"center",prop:"create_time"},{default:i(l=>[d("span",null,p(l.row.create_time||"-"),1)]),_:1},8,["label"]),n(" \u66F4\u65B0\u65F6\u95F4 "),a(c,{label:e.$t("\u7ED3\u675F\u65F6\u95F4"),"header-align":"center",align:"center",prop:"update_time"},{default:i(l=>[d("span",null,p(l.row.update_time||"-"),1)]),_:1},8,["label"]),a(c,{label:e.$t("\u6301\u7EED\u65F6\u95F4"),"header-align":"center",align:"center",prop:"total_time_label"},{default:i(l=>[d("span",null,p(l.row.total_time_label||"-"),1)]),_:1},8,["label"]),a(c,{label:e.$t("\u72B6\u6001"),"header-align":"center",align:"center",prop:"status",width:"60"},{default:i(l=>[n(" <span>{{ scope.row.status || '-' }}</span> "),a(m,{value:l.row.status},null,8,["value"])]),_:1},8,["label"]),a(c,{label:e.$t("\u6267\u884C\u7ED3\u679C"),"header-align":"center",align:"center",prop:"status"},{default:i(l=>[d("span",null,p(l.row.error_message||"-"),1)]),_:1},8,["label"]),n(" \u64CD\u4F5C "),n(` <el-table-column
        label="\u72B6\u6001"
        header-align="center"
        align="center"
        width="80"
